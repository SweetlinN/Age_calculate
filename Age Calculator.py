...
photo=PhotoImage(file="Age Calculator.png.png")
...
Label(text="Name",font=23,bg="red",fg="white").place(x=200,y=250)
Label(text="Year",font=23,bg="red",fg="white").place(x=200,y=300)
Label(text="Month",font=23,bg="red",fg="white").place(x=200,y=350)
Label(text="Day",font=23,bg="red",fg="white").place(x=200,y=400)
...
Button(text="Calculate Age",font=20,bg="yellow",fg="black",width=11,height=2,
       command=calculateAge).place(x=300,y=450)
